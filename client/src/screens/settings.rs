                                ...
                                content
                                    ...
                                    .with_children(|content| {
                                        volume_widget(
                                            content,
                                            window_height,
                                            asset_server.load("fonts/rajdhani/Rajdhani-Medium.ttf"),
                                            "Master Volume",
                ...
                ui.spawn((
                    ...
                    ui.spawn((
                        ...
                        for (i, category) in categories.into_iter().enumerate() {
                            ...
                            // Add the observers
                            }).observe(hover_set::<Pointer<Over>, true>).observe(hover_set::<Pointer<Out>, false>).observe(categories_actions[i]);
                        }
