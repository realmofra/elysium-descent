...
impl TrophyImpl of TrophyTrait {
    ...
    fn identifier(self: Trophy) -> felt252 {
        match self {
            ...
            Trophy::HuntersGatheringI => trophies::HuntersGathering::HuntersGathering::identifier(
                0,
            ),
            Trophy::HuntersGatheringII => trophies::HuntersGathering::HuntersGathering::identifier(
                1,
            ),
            Trophy::HuntersGatheringIII => trophies::HuntersGathering::HuntersGathering::identifier(
                2,
            ),
    ...
    fn description(self: Trophy) -> ByteArray {
        match self {
            ...
            Trophy::HuntersGatheringI => trophies::HuntersGathering::HuntersGathering::description(
                0,
            ),
            Trophy::HuntersGatheringII => trophies::HuntersGathering::HuntersGathering::description(
                1,
            ),
            Trophy::HuntersGatheringIII => trophies::HuntersGathering::HuntersGathering::description(
                2,
            ),
            ...
            Trophy::MagicalAssemblyIII => trophies::MagicalAssembly::MagicalAssembly::description(
                2,
            ),
