use elysium_descent::models::{
    Game, GameStatus, PlayerStats, GameCounter, GAME_COUNTER_ID,
...
#[dojo::contract]
pub mod actions {
    use super::{IActions, Game, GameStatus, PlayerStats, GameCounter, GAME_COUNTER_ID, get_block_timestamp, ItemType, PlayerInventory, LevelItems, WorldItem};
    ...
    impl InternalImpl of InternalTrait {
        ...
        fn generate_item_id(self: @ContractState, game_id: u32, level: u32, item_counter: u32) -> u32 {
        ...
        fn generate_item_position(self: @ContractState, game_id: u32, level: u32, item_counter: u32) -> (u32, u32) {
            let seed_x = poseidon_hash_span(array![game_id.into(), level.into(), item_counter.into(), 'POSX'.into()].span());
            let seed_y = poseidon_hash_span(array![game_id.into(), level.into(), item_counter.into(), 'POSY'.into()].span());
